export const cvData = {
  ...
  strengths: [
    {
      ...
      items: [
        "Python workflows for model development, evaluation, and iteration",
        "Deep learning implementation with PyTorch and TensorFlow",
        "Model explainability-aware thinking for visual prediction pipelines"
      ]
    },
    {
    ...
    {
      category: "Experimentation, Delivery & Tooling",
      items: [
  ...
  projects: [
    {
      ...
      highlights: [
        ...
        "Packaged for operational usability with interface-oriented delivery"
      ],
      repo: "https://github.com/jasgh14/DiseaseDetection"
    },
    {
      name: "E-commerce Analytics Platform",
      summary:
        "Analytics workflow built on SQL and Python transformation logic, then surfaced through dashboard-driven reporting.",
      highlights: [
    ...
    },
    {
      ...
      summary:
        "Automated plant disease monitoring concept combining computer vision and operational analysis workflows.",
      highlights: [
  ...
  interests: [
    ...
    "Computer vision for real-world monitoring",
    "Automation-first analytics workflows",
    "Interpretability and trustworthy AI delivery"
  ],
  links: [
    {
      label: "Email",
      value: "Junaid453@outlook.com",
      href: "mailto:Junaid453@outlook.com"
    },
    {
      label: "LinkedIn",
      value: "linkedin.com/in/junaid-asghar453",
      href: "https://www.linkedin.com/in/junaid-asghar453/"
    },
    {
      label: "GitHub",
      value: "github.com/jasgh14",
      href: "https://github.com/jasgh14"
    },
    {
      label: "PDF CV",
      value: "Download JunaidAsgharCV.pdf",
